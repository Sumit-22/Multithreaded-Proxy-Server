                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <p className="text-xs text-muted-foreground">
                            Note: Build and run the Java server separately from this UI. You can deploy this UI on any hosting
                            platform, while running the Java server locally or on your own backend server.
                        </p>
                    </CardContent>
                </Card>
            </div>
